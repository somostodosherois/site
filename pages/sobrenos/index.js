...
import MissaoImage from '../../public/icons/missao.png'
import VisaoImage from '../../public/icons/visao.png'
...
export default function Missoes() {
  return (
    <div>
      ...
      <div className="bg-white py-12 px-4 pb-32">
        <div className="grid max-w-7xl mx-auto sm:px-6 lg:items-center gap-y-24">

          <div className='flex justify-center items-center gap-x-24 text-center'>
            <div className='w-20'>
            ...
            <div className='w-20'>
              <BsBullseye className="h-20 w-20" fill="#DC2626"/>
            </div>
            {/* <img src={MissaoImage.src} width='300px' /> */}
          </div>

          <div className='flex justify-center items-center text-center gap-x-24'>
            <div className='w-20'>
              <BsEye className="h-20 w-20" fill="#DC2626"/>
            </div>
            ...
            {/* <img src={VisaoImage.src} width='300px' className='' /> */}
