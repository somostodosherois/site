...
const CallToAction = ({ slice }) => {
  ...
  const buttonLabel1 = buttons[0].button_label
  const buttonLink1 = buttons[0].button_link

  const buttonLabel2 = buttons[1]?.button_label
  const buttonLink2 = buttons[1]?.button_link
